    ...
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 20px" }}>
      ...
      <section style={{ marginBottom: 52 }}>
        <SectionHeading
          ...
          subtitle="Select athletes to compare across all dimensions"
        />
        <RadarView
      ...
      <section style={{ marginBottom: 52 }}>
        <SectionHeading
          number="02"
          title="GOAT Rankings"
          subtitle="All athletes ranked by your current weights"
        />
        <RankedBarChart
          athletes={safeAthletes}
          attributeMeta={safeAttributeMeta}
      ...
      <section style={{ marginBottom: 52 }}>
        <SectionHeading
          ...
          subtitle="Peak performance and longevity over the years"
        />
        <CareerTimeline
          athletes={safeAthletes}
          selectedAthletes={safeSelectedAthletes}
        ...
        >
          ...
          <p style={{ color: "#9ca3af", fontSize: 13, marginBottom: 16 }}>
            ...
            <strong style={{ color: "#e5e5e5" }}>
              {(topAthlete.score * 100).toFixed(1)}
            </strong>{" "}
            · Top traits:{" "}
            <strong style={{ color: "#e5e5e5" }}>
              {top2Reasons.join(", ")}
          ...
          <button
            ...
            style={{
              padding: "12px 32px",
              background: "none",
              border: `2px solid ${safeSport.color}`,
              borderRadius: 50,
              color: safeSport.color,
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.backgroundColor = `${safeSport.color}22`;
            }}
            onMouseLeave={(e) => {
